        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    ...
                    shadow transition-all hover:bg-emerald-600"> Add New
                    </Link>
                </div>
            }
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-">

                    {success && <div className="bg-emerald-500 py-2 px-4 text-white rounded mb-3 bg-opacity-100">
                        {success}
                    </div>}
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <div className="overflow-auto">
                                <table className="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                                    <thead className="text-xs uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-300 border-b-2 border-gray-300 dark:border-gray-600">
